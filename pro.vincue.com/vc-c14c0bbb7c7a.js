function setupVinCueVBC(window, document, jQuery, vbcplugin) {
    ...
    if (jQuery == undefined || typeof jQuery !== "function" || jQuery.fn == undefined) {
...
<a href="javascript:window.vbcStopScanner();" class="btn btn-danger btn-lg vbc-text-center vbc-cancel-button-link">Cancel</a>
    ...
    function setupVBCPlugin($) {
        ...
        ! function(a) {
            "use strict";
            "function" == typeof define && define.amd ? a(jQuery) : a("object" == typeof exports && "function" == typeof require ? require("jquery") : jQuery)
        }(function(a) {
            "use strict";
                                    ...
                                    y = function(e, t, n) {
                                        ...
                                        for (var I = [], C = 1, E = k + M, $ = 1 << k - 1, R = 0; R < k; R += 1) {
                                            ...
                                            for (var J = q; J >= K; J -= 1) {
                                                var T = J - 1,
                                                    U = n[e.charAt(T)];
                                                if (w && (L[T] = +!!U), W[J] = (W[J + 1] << 1 | 1) & U, R && (W[J] |= (I[J + 1] | I[J]) << 1 | 1 | I[J + 1]), W[J] & $ && (C = P(t, {
                                                        errors: R,
                                                        currentLocation: T,
                                                        expectedLocation: x,
                                                        distance: a,
        ...
        if (window.vbc_dealerId != 200103) {
            window.vbc_dealerId = 200103;
        }
        ...
        $('#vbcAutocomplete').devbridgeAutocomplete({
            ...
            transformResult: function(response) {
                return {
                    suggestions: $.map(response, function(dataItem) {
                        return {
                            value: dataItem.vehicleName,
                            data: dataItem.vehicleName,
                            year: dataItem.year,
                            mmid: dataItem.mmid,
                            trimid: dataItem.trimid
                        };
                    })
                };
            },
            ...
            onSelect: function(suggestion) {
                ...
                $('.vbcFullFrame').attr('src', 'https://pro.vincue.com/buyingcenter/contact.aspx?did=' + window.vbc_dealerId + '&vn=' + vn + "&mmid=" + mmid + "&year=" + year + "&trimid=" + trimid + "&vin=" + vin + "&extra=" + extra + "&wuid=" + vbcwebuserid + "&r=" + encodeURI(referer) + "&utm_source=" + utmSource + "&utm_medium=" + utmMedium + "&utm_campaign=" + utmCampaign + "&followdealer=0&lat=" + lat + "&long=" + long);
        ...
        $("#vbcAutocomplete").on('change keyup paste', function() {
            var vbcTxt = $("#vbcAutocomplete").val();
            $("#vbcvin").val(vbcTxt.length == 17 ? vbcTxt : "");
        });
        if ('/vc.js?c=1bsuc2e8a6nygw21&r=https://www.supercarguys.com/'.indexOf('?') > -1) {
            $.get("https://pro.vincue.com/vc.js?c=1bsuc2e8a6nygw21&r=https://www.supercarguys.com/" + "&c=1bsuc2e8oml01sog&r=" + encodeURI(document.location.href));
        } else {
            $.get("https://pro.vincue.com/vc.js?c=1bsuc2e8a6nygw21&r=https://www.supercarguys.com/" + "?c=1bsuc2e8oml01sog&r=" + encodeURI(document.location.href));
        }
