...
var PIRTSFPJS = function(e) {
    ...
    function c(e, c) {
        ...
        for (s = 0; s < l; s += 16) h = [255 & e.charCodeAt(s + 4) | (255 & e.charCodeAt(s + 5)) << 8 | (255 & e.charCodeAt(s + 6)) << 16 | (255 & e.charCodeAt(s + 7)) << 24, 255 & e.charCodeAt(s) | (255 & e.charCodeAt(s + 1)) << 8 | (255 & e.charCodeAt(s + 2)) << 16 | (255 & e.charCodeAt(s + 3)) << 24], p = [255 & e.charCodeAt(s + 12) | (255 & e.charCodeAt(s + 13)) << 8 | (255 & e.charCodeAt(s + 14)) << 16 | (255 & e.charCodeAt(s + 15)) << 24, 255 & e.charCodeAt(s + 8) | (255 & e.charCodeAt(s + 9)) << 8 | (255 & e.charCodeAt(s + 10)) << 16 | (255 & e.charCodeAt(s + 11)) << 24], h = r(h = n(h, v), 31), d = t(d = r(d = i(d, h = n(h, m)), 27), f), d = t(n(d, [0, 5]), [0, 1390208809]), p = r(p = n(p, m), 33), f = t(f = r(f = i(f, p = n(p, v)), 31), d), f = t(n(f, [0, 5]), [0, 944331445]);
        switch (h = [0, 0], p = [0, 0], u) {
            case 15:
                p = i(p, a([0, e.charCodeAt(s + 14)], 48));
            case 14:
                p = i(p, a([0, e.charCodeAt(s + 13)], 40));
            case 13:
                p = i(p, a([0, e.charCodeAt(s + 12)], 32));
            case 12:
                p = i(p, a([0, e.charCodeAt(s + 11)], 24));
            case 11:
                p = i(p, a([0, e.charCodeAt(s + 10)], 16));
            case 10:
                p = i(p, a([0, e.charCodeAt(s + 9)], 8));
            case 9:
                p = n(p = i(p, [0, e.charCodeAt(s + 8)]), m), f = i(f, p = n(p = r(p, 33), v));
            case 8:
                h = i(h, a([0, e.charCodeAt(s + 7)], 56));
            case 7:
                h = i(h, a([0, e.charCodeAt(s + 6)], 48));
            case 6:
                h = i(h, a([0, e.charCodeAt(s + 5)], 40));
            case 5:
                h = i(h, a([0, e.charCodeAt(s + 4)], 32));
            case 4:
                h = i(h, a([0, e.charCodeAt(s + 3)], 24));
            case 3:
                h = i(h, a([0, e.charCodeAt(s + 2)], 16));
            case 2:
                h = i(h, a([0, e.charCodeAt(s + 1)], 8));
            case 1:
                h = n(h = i(h, [0, e.charCodeAt(s)]), v), d = i(d, h = n(h = r(h, 31), m))
        }
        return d = t(d = i(d, [0, e.length]), f = i(f, [0, e.length])), f = t(f, d), d = t(d = o(d), f = o(f)), f = t(f, d), ("00000000" + (d[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (d[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (f[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (f[1] >>> 0).toString(16)).slice(-8)
    }
    var s = function() {
    ...
    function d() {
        ...
        var r = Array(e),
            a = 0;
        for (t = 0; t < n; t++)
            for (var i = arguments[t], o = 0, c = i.length; o < c; o++, a++) r[a] = i[o];
        return r
    }
                ...
                a = function() {
                    switch (e.startRendering(), e.state) {
                        case "running":
                            ...
                            break;
                        case "suspended":
                            document.hidden || r--, r > 0 ? setTimeout(a, 500) : n(_("suspended"))
                    }
                };
            a()
        }))
    ...
    function P(e, t, n) {
        var r, a;
        return void 0 === n && (n = 50), u(this, void 0, void 0, (function() {
            var i, o;
            return l(this, (function(c) {
                switch (c.label) {
                    ...
                    case 2:
                        return c.sent(), [3, 1];
                    case 3:
                        o = i.createElement("iframe"), c.label = 4;
                    case 4:
                        return c.trys.push([4, , 10, 11]), [4, new Promise((function(e, n) {
                            o.onload = e, o.onerror = n;
                            var r = o.style;
                            r.setProperty("display", "block", "important"), r.position = "absolute", r.top = "0", r.left = "0", r.visibility = "hidden", i.body.appendChild(o), t && "srcdoc" in o ? o.srcdoc = t : o.src = "about:blank"
                        }))];
                    case 5:
                        c.sent(), c.label = 6;
                    case 6:
                        return (null === (r = o.contentWindow) || void 0 === r ? void 0 : r.document.body) ? [3, 8] : [4, f(n)];
                    case 7:
                        return c.sent(), [3, 6];
                    case 8:
                    ...
                    case 9:
                        return [2, c.sent()];
                    case 10:
                        return null === (a = o.parentNode) || void 0 === a || a.removeChild(o), [7];
                    case 11:
                        return [2]
                }
            }))
    ...
    function T(e) {
        for (var t = function(e) {
                for (var t, n, r = "Unexpected syntax '" + e + "'", a = /^\s*([a-z-]*)(.*)$/i.exec(e), i = a[1] || void 0, o = {}, c = /([.:#][\w-]+|\[.+?\])/gi, s = function(e, t) {
                        o[e] = o[e] || [], o[e].push(t)
                    };;) {
                    var u = c.exec(a[2]);
                    if (!u) break;
    ...
    function R() {
        return u(this, void 0, void 0, (function() {
            ...
            return l(this, (function(t) {
                switch (t.label) {
                    case 0:
                        return j(e = G()) ? O ? [2, d(O)] : S() ? [4, (n = document, (n.exitFullscreen || n.msExitFullscreen || n.mozCancelFullScreen || n.webkitExitFullscreen).call(n))] : [3, 2] : [3, 2];
                    case 1:
                        t.sent(), e = G(), t.label = 2;
                    case 2:
                        return j(e) || (O = e), [2, e]
                }
                var n
    ...
    function G() {
        var e = screen;
        return [m(v(e.availTop), null), m(v(e.width) - v(e.availWidth) - m(v(e.availLeft), 0), null), m(v(e.height) - v(e.availHeight) - m(v(e.availTop), 0), null), m(v(e.availLeft), null)]
    }
    ...
    function N(e) {
        var t;
        return u(this, void 0, void 0, (function() {
            var n, r, a, i, o, c, s, u, d, h;
            return l(this, (function(l) {
                switch (l.label) {
                    case 0:
                        for (n = document, r = n.createElement("div"), a = [], i = {}, q(r), o = 0, c = e; o < c.length; o++) s = c[o], u = T(s), q(d = n.createElement("div")), d.appendChild(u), r.appendChild(d), a.push(u);
                        l.label = 1;
                    case 1:
                    ...
                    case 3:
                        ...
                        try {
                            for (h = 0; h < e.length; ++h) a[h].offsetParent || (i[e[h]] = !0)
                        } finally {
    ...
    var Ce = {
        fonts: function() {
            return P((function(e, t) {
                ...
                r.appendChild(a);
                for (var l = 0; l < E.length; l++) i[E[l]] = s[l].offsetWidth, o[E[l]] = s[l].offsetHeight;
                return I.filter((function(e) {
                    return t = u[e], E.some((function(e, n) {
                ...
                return l(this, (function(a) {
                    switch (a.label) {
                        case 0:
                            ...
                            }() ? [4, N((r = []).concat.apply(r, W.map((function(e) {
                                return U[e]
                            }))))] : [2, void 0];
                        case 1:
                            return e = a.sent(), t && function(e) {
                                for (var t = "DOM blockers debug:\n```", n = 0, r = W; n < r.length; n++) {
                                    var a = r[n];
                                    t += "\n" + a + ":";
                                    for (var i = 0, o = U[a]; i < o.length; i++) {
                                        var c = o[i];
                                        t += "\n  " + c + " " + (e[c] ? "🚫" : "➡️")
                                    }
                                }
                                console.log(t + "\n```")
                            }(e), (n = W.filter((function(t) {
                                var n = U[t];
            ...
            return function(e, t) {
                ...
                return P((function(n, r) {
                    var a = r.document,
                        i = a.body,
                        o = i.style;
                    o.width = t + "px", o.webkitTextSizeAdjust = o.textSizeAdjust = "none", y() ? i.style.zoom = "" + 1 / r.devicePixelRatio : k() && (i.style.zoom = "reset");
                    var c = a.createElement("div");
                    return c.textContent = d(Array(t / 20 << 0)).map((function() {
                        return "word"
                    })).join(" "), i.appendChild(c), e(a, i)
                }), '<!doctype html><html><head><meta name="viewport" content="width=device-width, initial-scale=1">')
            }((function(e, t) {
                for (var n = {}, r = {}, a = 0, i = Object.keys(ke); a < i.length; a++) {
                    var o = i[a],
                        c = ke[o],
                        s = c[0],
                        u = void 0 === s ? {} : s,
                ...
                for (var g = 0, b = Object.keys(ke); g < b.length; g++) {
                    r[o = b[g]] = n[o].getBoundingClientRect().width
                }
                return r
            }))
        },
                ...
                return l(this, (function(s) {
                    switch (s.label) {
                        case 0:
                            ...
                            n = 4500, 5e3, r = new t(1, 5e3, 44100), (a = r.createOscillator()).type = "triangle", a.frequency.value = 1e4, (i = r.createDynamicsCompressor()).threshold.value = -50, i.knee.value = 40, i.ratio.value = 12, i.attack.value = 0, i.release.value = .25, a.connect(i), i.connect(r.destination), a.start(0), s.label = 1;
                        case 1:
                            return s.trys.push([1, 3, , 4]), [4, x(r)];
                        case 2:
                            return o = s.sent(), [3, 4];
                        case 3:
                            if ("timeout" === (c = s.sent()).name || "suspended" === c.name) return [2, -3];
                            throw c;
                        case 4:
                            return [2, M(o.getChannelData(0).subarray(n))]
                    }
                }))
            }))
        },
        ...
        languages: function() {
            ...
            if (void 0 !== r && n.push([r]), Array.isArray(t.languages)) y() && g([!("MediaSettingsRange" in (e = window)), "RTCEncodedAudioFrame" in e, "" + e.Intl == "[object Intl]", "" + e.Reflect == "[object Reflect]"]) >= 3 || n.push(t.languages);
        ...
        deviceMemory: function() {
            return m(v(navigator.deviceMemory), void 0)
        },
        screenResolution: function() {
            var e = screen,
                t = [p(e.width), p(e.height)];
            return t.sort().reverse(), t
        },
        hardwareConcurrency: function() {
            return m(p(navigator.hardwareConcurrency), void 0)
        },
        timezone: function() {
            ...
            var r, a = (r = (new Date).getFullYear(), -Math.max(v(new Date(r, 0, 1).getTimezoneOffset()), v(new Date(r, 6, 1).getTimezoneOffset())));
        ...
        platform: function() {
            ...
            return "MacIntel" === e && k() && !C() ? function() {
        ...
        math: function() {
            return {
                ...
                acosh: Q(1e308),
                acoshPf: (e = 1e154, X.log(e + X.sqrt(e * e - 1))),
    ...
    function Ae(e, t, n) {
        return u(this, void 0, void 0, (function() {
            ...
            return l(this, (function(h) {
                switch (h.label) {
                    case 0:
                        r = [], a = {}, 16, i = Date.now(), o = function(o) {
                            var c;
                                    ...
                                    case 0:
                                        return function(e, t) {
                                            for (var n = 0, r = e.length; n < r; ++n)
                                                if (e[n] === t) return !0;
                                            return !1
                                        }(n, o) ? [2, "continue"] : (a[o] = void 0, r.push(function(e, t) {
                                            return u(this, void 0, void 0, (function() {
                                                var n, r, a, i;
                                                return l(this, (function(o) {
                                                    switch (o.label) {
                                                        case 0:
                                                            r = Date.now(), o.label = 1;
                                                        case 1:
                                                            return o.trys.push([1, 3, , 4]), i = {}, [4, e(t)];
                                                        case 2:
                                                            return i.value = o.sent(), n = i, [3, 4];
                                                        case 3:
                                                            return a = o.sent(), n = {
                                                                error: (c = a, c && "object" == typeof c && "message" in c ? c : {
                                                                    message: c
                                                                })
                                                            }, [3, 4];
                                                        case 4:
                                            ...
                                            a[o] = e
                                        }))), (c = Date.now()) >= i + 16 ? (i = c, [4, new Promise((function(e) {
                                            return setTimeout(e)
                                        }))]) : [3, 2]);
                                    case 1:
                                        return d.sent(), [3, 4];
                        ...
                        }, c = 0, d = Object.keys(e), h.label = 1;
                    case 1:
                        return c < d.length ? (f = d[c], [5, o(f)]) : [3, 4];
                    case 2:
                        h.sent(), h.label = 3;
                    case 3:
                        return c++, [3, 1];
        ...
        function e() {
            ! function() {
                if (void 0 === D) {
                    var e = function() {
                        var t = G();
                        j(t) ? D = setTimeout(e, 2500) : (O = t, D = void 0)
                    };
                    e()
                }
            }()
    ...
    var Te = {
        ...
        Ee = c;
    return e.componentsToDebugString = xe, e.default = Te, e.getComponents = Ae, e.getFullscreenElement = S, e.getScreenFrame = R, e.hashComponents = Me, e.isChromium = y, e.isDesktopSafari = C, e.isEdgeHTML = w, e.isGecko = A, e.isTrident = b, e.isWebKit = k, e.load = Pe, e.murmurX64Hash128 = Ee, e
}({});