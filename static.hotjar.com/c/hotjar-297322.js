window.hjSiteSettings = window.hjSiteSettings || {
    "site_id": 297322,
    "r": 0.4396541931216931,
    "rec_value": 0.018518518518518517,
    ...
    "features": ["survey.type_button", "feedback.widget_telemetry", "ask.use_insights_internal_api", "ingestion.http.page_content", "ask.separate_service", "feedback.widgetV2", "client_script.compression.pc", "ingestion.events_v2", "error_reporting", "survey.image_question", "settings.billing_v2", "heatmap.continuous.manual_retaker", "client_script.safe_date", "feedback.embeddable_widget"]
};
...
! function(e) {
    ...
    217: function(e, t, r) {
                ...
                timeEnd: function(e, t) {
                    ...
                    try {
                        ...
                        var o, s = p(e, r),
                            ...
                            f = s.total;
                        if (n) {
                            var d = n.start && a - n.start;
                            o = d ? (f || 0) + d : f;
                            var h = n.flush ? void 0 : {
                                total: o
                            };
                            g(e, c, h)
        ...
        window.hj = window.hj || function() {
            ...
            d.async = 1, d.src = hj.scriptDomain + t, d.charset = "utf-8", f.appendChild(d), c.revision = "0a63cab60c00", window.hjBootstrap = c
        }, window.hjBootstrap("https://script.hotjar.com/", "modules.6fed24b60091da3b9aa3.js", "297322"), window.hjLazyModules = window.hjLazyModules || {
            SURVEY_V2: {
                js: "survey-v2.884cc572f1d854b53501.js"
            },
            SURVEY_BOOTSTRAPPER: {
                js: "survey-bootstrapper.37dfb2ac952498c1797e.js"
            },
            SURVEY_ISOLATED: {
                js: "survey-isolated.9c982363b35a873cfc0c.js"
            },
            HEATMAP_RETAKER: {
                js: "heatmap-retaker.e16ce136d53e363bdf95.js"
            },
            SURVEY_INVITATION: {
                js: "survey-invitation.98ba9170f5d375b8fec3.js"
            },
            NOTIFICATION: {
                js: "notification.b7ac024525431d25de27.js"
            },
            INCOMING_FEEDBACK: {
                js: "incoming-feedback.3ab8bfcc51d0b80f62c5.js"
            },
            PREACT_INCOMING_FEEDBACK: {
                js: "preact-incoming-feedback.e93c10be21d43edc7062.js"
            },
            SENTRY: {
                js: "sentry.05e3843c72bfc5103281.js"
            }
        }
    }
});