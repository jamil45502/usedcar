/**
 * Swiper 4.1.6
 * uglifyjs --comments '/Swiper 4.1.6/' -o swiper.jquery.min.js swiper.jquery.js
 ...
 */
function isDiSlider(swiper) {
    if (typeof swiper != "undefined" && swiper.params.el) {
        return String(swiper.params.el).match(/\.di-slider/)
    }
    ...
    var Swiper$1 = function(SwiperClass$$1) {
        function Swiper() {
            ...
            if (typeof swiper.params.autoplay != "undefined" && typeof swiper.params.autoplay != "object" && typeof swiper.params.autoplay != "boolean") {
                var autoplaySpeed = swiper.params.autoplay;
                swiper.params.autoplay = {
                    delay: autoplaySpeed
                };
                if (typeof window.console != "undefined" && !isDiSlider(swiper)) {
                    console.warn('DI: The Swiper autoplay string has been deprecated in Swiper 4.x. Please use \n new Swiper(".swiper-element", { \n   autoplay : { \n     delay : "' + autoplaySpeed + '" \n   } \n } \n')
                }
            } else {
                if (typeof swiper.params.autoplay == "undefined") {
            ...
            if (swiper.params.autoplayStopOnLast) {
                ...
                swiper.params.autoplay.stopOnLastSlide = swiper.params.autoplayStopOnLast;
                if (typeof window.console != "undefined" && !isDiSlider(swiper)) {
                    console.warn('DI: The Swiper autoplayStopOnLast string has been deprecated in Swiper 4.x. Please use \n new Swiper(".swiper-element", { \n   autoplay : { \n     stopOnLastSlide : "' + autoplaySpeed + '" \n   } \n } \n')
                }
            }
            ...
            if (typeof swiper.params.pagination == "string") {
                var paginationString = swiper.params.pagination;
                swiper.params.pagination = {};
                swiper.params.pagination.el = paginationString;
                if (typeof window.console != "undefined" && !isDiSlider(swiper)) {
                    console.warn('DI: The Swiper pagination string has been deprecated in Swiper 4.x. Please use \n     new Swiper(".swiper-element", { \n      pagination : { \n        el : "' + paginationString + '" \n      } \n     } \n')
                }
            }
            if (typeof swiper.params.paginationClickable != "undefined" && swiper.params.paginationClickable) {
                swiper.params.pagination.clickable = true;
                if (typeof window.console != "undefined" && !isDiSlider(swiper)) {
                    console.warn('DI: The Swiper paginationClickable setting has been deprecated in Swiper 4.x. Please use \n     new Swiper(".swiper-element", { \n       pagination : { \n         clickable : ' + true + " \n       } \n     } \n")
                }
            }
    ...
    var Navigation = {
        ...
        init: function init() {
            var swiper = this;
            var params = swiper.params.navigation;
            if (typeof swiper.params.lazyLoading != "undefined") {
                swiper.params.lazy.enabled = swiper.params.lazyLoading;
                if (typeof window.console != "undefined" && !isDiSlider(swiper)) {
                    console.warn('DI: The Swiper lazyLoading option has been deprecated in Swiper 4.x. Please use \n  new Swiper(".swiper-element", { \n    lazy : { \n      enabled : true, \n      loadOnTransitionStart : true \n    } \n  }')
                }
            }
            if (!(params.nextEl || params.prevEl)) {
                if (swiper.params.nextButton && swiper.params.prevButton) {
                    params.nextEl = swiper.params.nextButton;
                    params.prevEl = swiper.params.prevButton;
                    if (typeof window.console != "undefined" && !isDiSlider(swiper)) {
                        console.warn('DI: The Swiper nextButton and prevButton have been deprecated in Swiper 4.x. Please use \n  new Swiper(".swiper-element", { \n    navigation : { \n      nextEl : ".your-next-btn-class", \n      prevEl : ".your-prev-btn-class" \n    } \n  }')
                    }
                } else {
                    return
                }
