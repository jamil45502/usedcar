...
(function() {
    ...
    */
    ...
    me.sd = Number("0") || 0;
    me.ia = "dataLayer";
    me.Ii = "ChAI8I2CowYQn+fYyYTCnq0MEiQAOnAe4PLrbe8T4P03DxB3szjKlmyPKt6faQY95VligaPcg/EaAssa";
    var pe = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
    ...
    var hj = ej,
        ij = "https://www.googletagmanager.com/a?id=" + U.C + "&cv=1";
    ...
    var ow = function() {
        ...
        sw = function(a, b) {
            function c() {
                var q = a.h.D ? T(a.h, "oref") : vf(wf(z.location.href));
                pw(q) && (0, a.metadata.add_parameter)("~oref", !d && f ? xf(q) : q);
                gm(a);
                if (a.isAborted) F(a.h.P);
                else {
                    for (var t = [], r = a.metadata.parameter_order, u = 0; u < r.length; ++u) {
                        var v = r[u];
                        t.push(v + "=" + a.m[v])
                    }
                    var w = n + t.join(";") + "?";
                    a.metadata.send_as_iframe ? Mb(w, a.h.M) : Nb(w, a.h.M, a.h.P);
                    a.metadata.attribution_reporting_experiment && Wb("https://ad.doubleclick.net/activity;register_conversion=1;" + t.join(";") + "?", {
                        headers: {
                            "Attribution-Reporting-Eligible": "trigger"
                        },
                        keepalive: !0
                    });
                    if (S(27) && d && !1 !== T(a.h, N.g.Aa) && !1 !== T(a.h, N.g.V) && Wm()) {
                        var x = Ym() + "/td/fls/rul/activityi;fledge=1;" + t.join(";") + "?";
                        Xm(x, e.target.id)
                    }
                }
            }
            ...
            for (var l = 0; l < rw.length; ++l) rw[l](a);
            var m = e.target.J[0],
                n = d ? a.metadata.send_as_iframe ? "https://" + m + ".fls.doubleclick.net/activityi;" : "https://ad.doubleclick.net/activity;" : "https://ade.googlesyndication.com/ddm/activity/",
        ...
        tw = function(a) {
            var b = T(a.h, N.g.Ng);
            if (G(b) && b.exclusion_parameters && b.engines)
                if (ai()) {} else {
                    var c = a.metadata.conversion_linker_enabled,
                        ...
                        e = function() {
                            ...
                            c && (al(d), f.auiddc = Xk(d.prefix));
                            void 0 === z.__dc_ns_processor && (z.__dc_ns_processor = []);
                            z.__dc_ns_processor.push(f);
                            Kb("https://www.googletagmanager.com/dclk/ns/v1.js")
                        };
                    a.metadata.consent_ad_storage ? e() : Yg(e, N.g.H)
                }
        },
        qw = function(a) {
            var b = rh(N.g.H);
        ...
        ww = function(a, b, c, d) {
            if (S(99)) lw(a, b, d);
                ...
                a: {
                    var f = Ol(a);
                    if (f && (1 === f.J.length || 3 === f.J.length)) {
                        var g = f.J[1] || "",
                            l = f.J[2],
                            m = "",
                            n = 1;
                ...
                var q = e;
                if (q) {
                    var t = new cm(q.target,
                        b, d);
                    t.metadata.parsed_target = q;
                    for (var r = 0; r < vw.length && (vw[r](t), !t.isAborted); ++r);
                } else F(d.P)
            }
        },
        vw = [function(a) {
            a.metadata.conversion_linker_enabled = !1 !== T(a.h, N.g.wa)
        }, function(a) {
            var b = {
                prefix: T(a.h, N.g.Ha) || T(a.h, N.g.Ia),
                domain: T(a.h, N.g.La),
                kb: T(a.h, N.g.Ba),
                flags: T(a.h, N.g.Ma)
            };
            ...
            if (a.eventName === N.g.Ga && !a.h.D) {
                var b = {
                    callback: T(a.h, N.g.cb),
                    hg: T(a.h, T(a.h, N.g.Na)),
                    vg: T(a.h, N.g.Na)
                };
                Rm(b, a.metadata.cookie_options, a.metadata.redact_ads_data, tm);
                a.isAborted = !0;
                F(a.h.M)
            }
        }, function(a) {
            if (a.eventName === N.g.qa && !a.h.D) {
        ...
        rw = [function(a) {
            ...
            (0, a.metadata.add_parameter)("gtm", ni())
        }, function(a) {
            if (Tg()) {
                var b =
                    a.metadata.add_parameter;
            ...
            "1" === Jk(!1)._up && (0, a.metadata.add_parameter)("gtm_up", "1")
        }, function(a) {
            !1 === T(a.h, N.g.V) && (0, a.metadata.add_parameter)("npa", 1)
        }, function(a) {
            if (a.metadata.conversion_linker_enabled) {
                ...
                if (a.metadata.send_as_iframe) {
                    var g = "_gcl" !== rl(c.prefix);
                    if (f || !xm(c.prefix)) {
                        var l = sm(c.prefix, d);
                        l && l.length && (b("gclaw", l.join(".")), L(59));
                        var m = um(d);
                        m && (g || b("gac", m))
                    } else {
                        var n = om("gb", c.prefix, d);
            ...
            function b(p, q, t) {
                pw(t) && f.push(p + q + ":" + encodeURIComponent(t +
                    ""))
            }
            ...
            if (5 === c.yc || 6 === c.yc) {
                ...
                if (ua(e)) {
                    for (var f = [], g = 0; g < e.length; g++) {
                        ...
                        b("p", m, l.price);
                        b("q", m, l.quantity);
                        b("c", m, d ? l[N.g.vb] : T(a.h, N.g.vb));
                        b("l", m, d ? l[N.g.xa] : T(a.h, N.g.xa));
                        d && b("a", m, l.accountId)
                    }
                    var n = f.join("|");
                    pw(n) && (0, a.metadata.add_parameter)("prd", n, !0)
                }
            }
        }, function(a) {
            var b = T(a.h, N.g.kc),
                c = {};
            G(b) && k(b, function(l, m) {
                h(m) && xw.test(l) && (c[l] = m)
            });
            for (var d = Am(a.h), e = 0; e < d.length; e++) {
                var f = d[e];
                xw.test(f) && (c[f] = f)
            }
            ...
            var b = a.metadata.add_parameter,
                c = Qa(Bm(a.h, N.g.X, 1), ".");
            pw(c) && b("gdid", c);
            var d = Qa(Bm(a.h, N.g.X, 2), ".");
            pw(d) && b("edid", d)
        }, function(a) {
            var b = a.metadata.consent_ad_storage && ow();
        ...
        function() {
            (function(a) {
                ...
                var b = !a.hasOwnProperty("vtp_enableConversionLinker") || !!a.vtp_enableConversionLinker,
                    c = Kx(a.vtp_customVariable || [], "key", "value") || {},
                    d = {},
                    e = (d[N.g.la] = At(N.g.la), d[N.g.Zd] = !0 === a.vtp_useImageTag ? !1 : !0, d[N.g.Ha] = a.vtp_conversionCookiePrefix || void 0, d[N.g.wa] = b, d[N.g.hb] = a.vtp_sessionId, d.oref = a.vtp_useImageTag ? void 0 : a.vtp_url, d.tran = a.vtp_transactionVariable,
                        d.u = a.vtp_userVariable, d[N.g.na] = a.vtp_userDataVariable, d);
                S(27) && (e[N.g.Aa] = At(N.g.Aa), e[N.g.V] = At(N.g.V));
                ...
                var g = "DC-" + a.vtp_advertiserId + "/" + a.vtp_groupTag + "/" + (a.vtp_activityTag + "+" + ({
                    ...
                    l = Om(Nm(Mm(Lm(Em(new Dm(a.vtp_gtmEventId, a.vtp_gtmPriorityId), e), a.vtp_gtmOnSuccess), a.vtp_gtmOnFailure)));
                ww(g, "", Date.now(), l)
            })
        }();
    Z.o.e = ["google"],
