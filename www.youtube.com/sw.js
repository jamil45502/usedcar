...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "max_prefetch_window_sec_for_livestream_optimization": 15,
        "min_prefetch_offset_sec_for_livestream_optimization": 15,
        ...
        "web_async_context_processor_impl": "",
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20230512.01.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "clientName": "WEB",
            "clientVersion": "2.20230512.01.00"
        }
    },
    "INNERTUBE_CONTEXT_CLIENT_NAME": 1,
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20230512.01.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    const swPolicy = trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(ignored) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/c1d331ff\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(swPolicy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/c1d331ff\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}